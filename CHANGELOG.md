...
### Fixed
- **Syntax error** in `core/models/profile.js` constructor missing closing brace which caused "Unexpected strict mode reserved word" on startup; now static `fromObject` method is correctly placed.
